...
| 2   | Unsuccessful request with incorr income. Status 400                                | income: 0; age: 17, 50; debt: 1, 100; loanPeriod: 1, 10               | Passed |
| 3   | Unsuccessful request with incorr debt. Status 400                                  | income: 1, 100; age: 17, 50; debt: -100; loanPeriod: 1, 10            | Passed |
| 4   | Unsuccessful request with incorr age. Status 400                                   | income: 1, 100; age: 0, 1, 8, 15, 16; debt: 1, 100; loanPeriod: 1, 10 | Failed |
| 5   | Unsuccessful request with negative loanAmount. Status 400                          |                                                                       | Passed |
| 6   | Unsuccessful request with incorr loanPeriod. Status 400                            | income: 1, 100; age: 17, 50; debt: 1, 100; loanPeriod: 0, -1          | Passed |
...
| 14  | Unsuccessful request with empty income. Status 400                                 |                                                                       | Passed |
| 15  | Unsuccessful request with empty debt. Status 400                                   |                                                                       | Failed |
| 16  | Unsuccessful request with empty age. Status 400                                    |                                                                       | Passed |
| 17  | Unsuccessful request with empty employed. Status 400                               |                                                                       | Failed |
| 18  | Unsuccessful request with empty empty loanAmount. Status 400                       |                                                                       | Passed |
| 19  | Unsuccessful request with empty loanPeriod. Status 400                             |                                                                       | Passed |
